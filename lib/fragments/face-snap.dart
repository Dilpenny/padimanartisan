...
class FaceSnapPage extends StatefulWidget {
  const FaceSnapPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  State<FaceSnapPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<FaceSnapPage> {
