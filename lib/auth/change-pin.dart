...
class ChangePinPage extends StatefulWidget {
  ...
  @override
  ChangePinPageWidget createState() => ChangePinPageWidget();
}


class ChangePinPageWidget extends State<ChangePinPage> {
  int processing = 0;
...
//    List<Map> details = sqLiteDbProvider.getUser();
  ...
  Future<void> change_password() async {
    ...
    try {
      ...
      var url = Uri.parse(Component().API+'mobile/change/pin');
