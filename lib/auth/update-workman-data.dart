...
class UpdateWorkmanDataPage extends StatefulWidget {

  @override
  UpdateWorkmanDataPageWidget createState() => UpdateWorkmanDataPageWidget();
}


class UpdateWorkmanDataPageWidget extends State<UpdateWorkmanDataPage> {
  int processing = 0;
...
//    List<Map> details = sqLiteDbProvider.getUser();
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Update workman data", style: GoogleFonts.quicksand(),),
      ),
      backgroundColor: whiteColor,
  ...
  Future<void> become_a_wormkman() async {
    ...
    try {
      ...
      var url = Uri.parse(Component().API+'mobile/update/artisan');
